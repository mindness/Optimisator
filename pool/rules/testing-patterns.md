---
id: testing-patterns
name: "Testing Patterns Reference"
type: rule
domain: dev
tags: [testing, patterns, reference, assertions, mocking, javascript, typescript, vitest, jest]
description: "Shows how to write the test once you know you need one. Use as a reference while writing JavaScript or TypeScript tests: arrange-act-assert structure, naming, assertions, mocking, component testing and API integration testing."
source:
