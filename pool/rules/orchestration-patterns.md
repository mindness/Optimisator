...
type: rule
domain: meta
tags: [orchestration, subagents, delegation, parallelism, workflow, multi-agent]
description: "Decides how to split work across agents and when not to. Use when coordinating subagents or designing a multi-step workflow: delegation patterns, parallelism, a decision flow, the anti-patterns that waste turns, and Claude Code compatibility notes."
source:
