...
- [ ] **Step 5: Git commit : `feat(engine): implement deterministic french tax calculation engine`** — *reporté*
...
- [x] Mesure 60 fps DevTools (optionnel) → procédure [docs/performance-60fps.md](../performance-60fps.md) (trace instrumentée manuelle encore ouverte)
- [ ] Deploy Cloudflare / SaaS public → plus tard, hors MVP perso
- [ ] Trace DevTools 60 fps jointe (mesure réelle)